...
// public class FourOfAKindSkill : Skill
// {
//     // 생성자에서 멤버 변수 초기화
//     public FourOfAKindSkill()
//     {
//         Initialize(SkillID.FourOfAKind);
//     }

//     // IsPossible 상태는 스킬 매니저에서 바꿔주는 것을 의도함
//     public override bool OnCheck(DiceCalculateDto diceDto)
//     {
//         return diceDto.SortedCountList[0].Value >= 4;
//     }
...
//         {
//             if (diceDto.PairLargePips.TryGetValue(4, out int largePip))
//             {
